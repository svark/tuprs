...
mod tests {
    ...
    pub fn test_parsedir() {
        ...
        let expected = if cfg!(windows) {
            r#"ResolvedLink { primary_sources: [GroupEntry(<output0>, b/out0.txt)], secondary_sources: [], rule_formula_desc: cp %<output0> out1.txt, primary_targets: [a/out1.txt], secondary_targets: [], excluded_targets: [a/^.*FltMgrMsg], group: None, bin: None, rule_ref: TupLoc { tup_path_desc: a/Tupfile, loc: Loc { line: 2, col: 1, span: 382 } }, env: EnvDescriptor(0) }
ResolvedLink { primary_sources: [], secondary_sources: [GroupEntry(<output2>, a/out2.txt)], rule_formula_desc: touch out7.txt, primary_targets: [a/out7.txt], secondary_targets: [], excluded_targets: [], group: None, bin: Some(a/o7), rule_ref: TupLoc { tup_path_desc: a/Tupfile, loc: Loc { line: 3, col: 1, span: 320 } }, env: EnvDescriptor(0) }
...
ResolvedLink { primary_sources: [GroupEntry(<output2>, a/out2.txt)], secondary_sources: [], rule_formula_desc: cp %<output2> out3.txt, primary_targets: [b/out3.txt], secondary_targets: [], excluded_targets: [b/^.*FltMgrMsg], group: None, bin: None, rule_ref: TupLoc { tup_path_desc: b/Tupfile, loc: Loc { line: 6, col: 1, span: 74 } }, env: EnvDescriptor(0) }
...
"#
    ...
    fn test_script() {
        ...
        let expected = if cfg!(windows) {
            r#"ResolvedLink { primary_sources: [Deglob(MatchingPath { path_descriptor: a/in0.txt, path: NormalPath { inner: "a/in0.txt" }, glob_descriptor: None, captured_globs: [] })], secondary_sources: [], rule_formula_desc: cp -r in0.txt outs.txt, primary_targets: [a/outs.txt], secondary_targets: [], excluded_targets: [], group: Some(<mygrp>), bin: None, rule_ref: TupLoc { tup_path_desc: a/Tupfile.lua, loc: Loc { line: 15, col: 0, span: 0 } }, env: EnvDescriptor(0) }
ResolvedLink { primary_sources: [Deglob(MatchingPath { path_descriptor: b/in1.txt, path: NormalPath { inner: "b/in1.txt" }, glob_descriptor: None, captured_globs: [] })], secondary_sources: [GroupEntry(<mygrp>, a/outs.txt)], rule_formula_desc: cp -r in1.txt outs.txt, primary_targets: [b/outs.txt], secondary_targets: [], excluded_targets: [], group: None, bin: Some(b/mybin), rule_ref: TupLoc { tup_path_desc: b/Tupfile.lua, loc: Loc { line: 15, col: 0, span: 0 } }, env: EnvDescriptor(0) }"#
        } else {
            "ResolvedLink { primary_sources: [Deglob(MatchingPath { path_descriptor: b/in1.txt, path: NormalPath { inner: \"b/in1.txt\" }, glob_descriptor: None, captured_globs: [] })], secondary_sources: [GroupEntry(<mygrp>, a/outs.txt)], rule_formula_desc: cp -r in1.txt outs.txt, primary_targets: [b/outs.txt], secondary_targets: [], excluded_targets: [], group: None, bin: Some(b/mybin), rule_ref: TupLoc { tup_path_desc: b/Tupfile.lua, loc: Loc { line: 5, col: 0, span: 0 } }, env: EnvDescriptor(0) }\nResolvedLink { primary_sources: [Deglob(MatchingPath { path_descriptor: a/in0.txt, path: NormalPath { inner: \"a/in0.txt\" }, glob_descriptor: None, captured_globs: [] })], secondary_sources: [], rule_formula_desc: cp -r in0.txt outs.txt, primary_targets: [a/outs.txt], secondary_targets: [], excluded_targets: [], group: Some(<mygrp>), bin: None, rule_ref: TupLoc { tup_path_desc: a/Tupfile.lua, loc: Loc { line: 5, col: 0, span: 0 } }, env: EnvDescriptor(0) }"
        };
        assert_eq!(outs, expected);
    }
}
